...
class Account:
    ...
    def generateTransaction(self, start_date):
        ...
        transaction_list.append(Transaction(
            ...
            type='INCOME',
            description="{} pay to {}: {:.2f}".format(self.account_id, 'INCOME', self.income),
            posted=start_date,
        ...
        if self.type != 'SAVING':
            for spending, frequency in spending_frequency.items():
                ...
                for i in range(transaction_num):
                    ...
                    transaction_list.append(Transaction(
                        ...
                        type=spending,
                        description="{} pay to {}: {:.2f}".format(self.account_id, merchant, amount),
                        posted=posted_date,
            ...
            if self.housing_type is not None:
                ...
                transaction_list.append(Transaction(
                    ...
                    type=type,
                    description="{}: {:.2f}".format(type, value),
                    posted=start_date,
                    completed=add_deltatime(start_date),
                    new_balance=self.balance['amount'],
                    value=value
